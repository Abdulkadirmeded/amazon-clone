  ...
  return (
    <div className='w-full bg-white py-6'>
      <div className='w-full border-t-[1px] border-b-[1px] py-8'>
        <div className='w-64 mx-auto text-center flex flex-col g-1'>
            ...
            <p className='text-xs mt-1'>New Customer <span className='text-blue-600
            ml-1 cursor-pointer'>Start Here.</span></p>
        </div>
      </div>
    </div>
  )
